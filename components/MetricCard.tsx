...
<div className="flex items-center justify-between">
        <div className={`flex h-10 w-10 items-center justify-center rounded-xl ${iconTones[tone]} shadow-sm backdrop-blur-xs`}>
      ...
      <div className="mt-3">
        <p className="font-mono text-[10px] font-extrabold uppercase tracking-[0.16em] opacity-80">
          {label}
        </p>
